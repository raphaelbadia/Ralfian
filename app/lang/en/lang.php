...
define( "item_unit_15", "%" );
define( "item_desc_15", "The architects of the village live in the ".__FILE__." building. The higher the level, the faster other buildings will be built or upgraded." );
...
define("item_27","Treasury");
define("item_title_27",item_27);
define("item_curprod_27","");
define("item_nextprod_27","");
define("item_unit_27","");
define("item_desc_27","<br><p><br>The riches of your empire are kept in the treasury. A treasury can only store one artefact. ");
...
define( "item_unit_41", "%" );
define( "item_desc_41", "With the Horse Drinking Pool, your Cavalry re".__FILE__." in better health and therefore train faster and consume less crop." );
...
define( "troop_104", "Fares Persians" );
...
define( "troop_desc_25", "This medium cavalry unit is outfitted for defense. The ".__FILE__." purpose of the Druidrider is definitely defense against infantry. His costs and upkeep are relatively expensive, however." );
...
define( "troop_desc_55", "Diphtheria is a knight knight warrior who makes his enemies forces shrink in fear. He is also an excellent defender against the Knights of the enemy. However, training and ".__FILE__."tenance costs are high." );
define( "troop_desc_56", "Fares arrows is a strong warrior, who makes his enemies shrink in fear. It is also an excellent defender against the enemy knights and infantry as well. However, training and ".__FILE__."tenance costs are high" );
...
define( "troop_desc_100", "Bowman is a type of infantry Persian Empire. Received training in many areas, and is useful in attack and defense but also in the best of cases would not reach the strength of specialized units." );
...
define( "troop_desc_102", "Infantry is the most powerful Persian forces in the attack, and also in defense and is slower and more expensive than other units small price for the defense and attack Jabbar" );
define( "troop_desc_103", "Spyware is a bird spy units in Persianic, is exceptional speed and is able to spy on enemy forces in secret, as well as resources or defenses if theres no spies in the village of the enemy, you will not know them to visit them, but no offensive ability" );
define( "troop_desc_104", "This is the unit normal of the Knights of the Persians. They are fast but well-armed and well armored, it is terror to all who are not ready. Kmalk should be noted that eating horse and rider are not cheap at all!" );
define( "troop_desc_105", "Fares axes is a strong warrior, who makes his enemies shrink in fear. It is also an excellent defender against the enemy knights and infantry as well. However, training and ".__FILE__."tenance costs are high" );
...
define( "medal_5", "The medal was awarded to three weeks since you've been on the list of improvements" );
define( "medal_row_5", "The medal was awarded to three weeks since you've been on the list of improvements" );
define( "medal_6", "The medal was awarded to three weeks since you've been on the list of offender " );
define( "medal_row_6", "The medal was awarded to three weeks since you've been on the list of offender " );
define( "medal_7", "The medal was awarded to three weeks since you've been on the list of offender defenders" );
define( "medal_row_7", "The medal was awarded to three weeks since you've been on the list of offender defenders" );
define( "medal_8", "The medal was awarded to three weeks since you've been on the list of offender robber" );
define( "medal_row_8", "The medal was awarded to three weeks since you've been on the list of offender robber" );
define( "medal_9", "The medals were awarded to the defenders and attackers have been a couple of weeks on the list" );
define( "medal_row_9", "The medals were awarded to the defenders and attackers have been a couple of weeks on the list" );
define( "medal_11", "Climbers" );
define( "medal_row_11", "Climbers" );
define( "medal_12", "Attackers" );
define( "medal_row_12", "Attackers" );
define( "medal_13", "Defenders" );
define( "medal_row_13", "Defenders" );
define( "medal_14", "Robbers" );
define( "medal_row_14", "Robbers" );
...
define( "report_result_text11", "Traders have been ".__FILE__."ly the transfer of wood" );
define( "report_result_text12", "Traders have been ".__FILE__."ly the transfer of mud" );
define( "report_result_text13", "Traders have been ".__FILE__."ly the transfer of iron" );
define( "report_result_text14", "Traders have been the transfer of wheat ".__FILE__."ly" );
...
define( "report_p_oasiscaptureded", "warrior dealer was occupied" );
...
define( "tatar_tribe_desc", "Tatar<br>===============<br><img src=\"assets/default/img/ww_start.jpg\" border=\"0\" alt=\"World Wonder\"><br>===============" );
...
define( "profile_medal_txt_Point", "Point" );
...
define( "register_player_txt_refrence", "(This name is Refrencer)" );
...
define( "alliance_p_status6", "NOT LOGIN" );
...
define( "time_re".__FILE__."_lang", "time re".__FILE__ );
...
define( "v2v_p_playerwas_Rest", "<p><br><font size=3 color=red><b>The players spent on Vacation</b></font>" );
define( "INSTALLER", "Please Delete Installer Folder" );
define( "LANGUI_MSG_ERROR", "Wrong Code " );
define( "time_remain_lang", "Remaing Time: " );
